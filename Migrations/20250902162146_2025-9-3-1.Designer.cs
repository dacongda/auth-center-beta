...
namespace AuthCenter.Migrations
{
    ...
    [Migration("20250902162146_2025-9-3-1")]
    partial class _2025931
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthCenter.Models.Application", b =>
                {
                    ...
                    b.Property<bool>("EnableAuthorizeConfirm")
                        .HasColumnType("boolean")
                        .HasColumnName("enable_authorize_confirm");
            ...
            modelBuilder.Entity("AuthCenter.Models.UploadFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AuthCenter.Models.UserThirdpartInfo", b =>
                {
                    ...
                    b.Property<string>("ThirdPartName")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("third_part_name");
            ...
            modelBuilder.Entity("AuthCenter.Models.Application", b =>
                {
                    ...
                    b.OwnsOne("AuthCenter.Models.ApplicationTheme", "Theme", b1 =>
                        {
                    ...
                    b.OwnsMany("AuthCenter.Models.SamlAttribute", "SamlAttributes", b1 =>
                        {
                            b1.Property<int>("FakeId")
                                .HasColumnType("integer");
                    ...
                    b.OwnsMany("AuthCenter.Models.SamlRedirect", "SamlRedirects", b1 =>
                        {
                            b1.Property<int>("FakeId")
                                .HasColumnType("integer");
                    ...
                    b.Navigation("SamlAttributes");

                    b.Navigation("SamlRedirects");
